## Hi there 👋
# 💫 About Me:
### About Me 👋<br><br>🛠️ I’m currently working on:<br>- A personal mobile app using **React Native Expo**.<br><br>🌱 I’m currently learning:<br>- **Angular** and **Node.js**<br><br>💬 Ask me about:<br>- React, Next.js, Tailwind, or building mobile apps with React Native Expo<br><br>⚡ Fun fact:<br>- I originally studied Civil Engineering but found my passion in web development 🚀<br>
...
<img src="https://tailwindcss.com/_next/static/media/tailwindcss-mark.d52e9897.svg" alt="TailwindCSS" width="45" height="45"/>
...
<img src="https://simpleicons.org/icons/nextdotjs.svg" alt="Next.js" width="45" height="45"/>
  <div style="display:inline-block; background-color:#1e1e1e; padding:6px; border-radius:8px;">
  <svg role="img" viewBox="0 0 24 24" width="45" height="45" xmlns="http://www.w3.org/2000/svg">
    <title>Next.js</title>
    <path d="M18.665 21.978C16.758 23.255 14.465 24 12 24 5.377 24 0 18.623 0 12S5.377 0 
             12 0s12 5.377 12 12c0 3.583-1.574 6.801-4.067 9.001L9.219 7.2H7.2v9.596h1.615V9.251l9.85 
             12.727Zm-3.332-8.533 1.6 2.061V7.2h-1.6v6.245Z" fill="white"/>
  </svg>
</div>
